...
// 获取所有文章分类列表
exports.getArtcleCates = (req, res) => {
...
exports.addArticleCates = (req, res) => {
    ...
    db.query(sql, [req.body.name, req.body.alias], (err, results) => {
        ...
        da.query(sql, req.body, (err, results) => {
            if (err)
                return res.cc(err)
...
exports.updateCateById = (req, res) => {
    const sql = `select * form ev_article_cate where Id <>? and (name =? or alias=?)`
